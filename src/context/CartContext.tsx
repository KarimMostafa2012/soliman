...
export const CartProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const updateCart = (itemId: string, quantity: number, selectedColor?: string, selectedSize?: string) => {
        dispatch({ type: 'UPDATE_CART', payload: { itemId, quantity, selectedColor: selectedColor ?? "", selectedSize: selectedSize ?? "" } });
    };
