...
const VariableProduct: React.FC<Props> = ({ data, productId }) => {
  ...
  const [timeLeft, setTimeLeft] = useState(countdownTime("2025-11-16"));

  useEffect(() => {
    const timer = setInterval(() => {
      setTimeLeft(countdownTime("2025-11-16"));
    }, 1000);
                ...
                <div className="choose-color mt-5">
                  ...
                  <div className="list-color flex items-center gap-2 flex-wrap mt-3">
                    {productMain.variation.map((item, index) => (
                      ...
                      >
                        <Image
                          src={item.colorImage ?? '/fallback.png'} // provide a fallback image
                          width={100}
                          height={100}
                          alt="color"
